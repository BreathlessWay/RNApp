...
import { FavoriteType } from 'trending/stores/favorite/favorite';

import { EFavoriteTab, PAGE_SIZE } from 'trending/config/constant';
...
export default class FavoriteStore {
	...
	setPopularFavorite({
		...
		if (isFavorite) {
			...
			this.popularFavorite = this.popularFavorite.filter(
				(_) => _.id !== item.id,
			);
